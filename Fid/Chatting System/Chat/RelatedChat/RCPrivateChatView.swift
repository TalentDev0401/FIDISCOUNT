...
class RCPrivateChatView: RCMessagesView, UIGestureRecognizerDelegate {
	...
	override func viewWillAppear(_ animated: Bool) {
        ...
        navigationController?.navigationBar.barTintColor = UIColor(hexString: "#092D37")
    ...
    // MARK: - Send share link in chat
    
    func setShareLink() {
        if FidHelper.shared.chatsFromBenefit {
            FidHelper.shared.chatsFromBenefit = false
            if let benefit = FidHelper.shared.benefit {
