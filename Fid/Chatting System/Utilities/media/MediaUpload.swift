...
class MediaUpload: NSObject {
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------
    class func benefit(_ name: String, data: Data, completion: @escaping (Error?) -> Void) {

        startWithJpeg(dir: "benefits", name: name, ext: "jpg", data: data, completion: completion)
    }
    ...
    private class func startWithJpeg(dir: String, name: String, ext: String, data: Data, completion: @escaping (Error?) -> Void) {
        
        FireStorage.uploadJPEGTYPE(dir: dir, name: name, ext: ext, data: data, completion: completion)
    }
}
