...
class ShowLikesVC: UIViewController {
    ...
    func loadProducts() {
        ...
        let realm = try! Realm()
        let object = realm.objects(LikeBenefit.self)
        for item in object {
    ...
    func actionDelete(at indexPath: IndexPath) {
        ...
        alert.addAction(UIAlertAction(title: "Delete", style: .destructive) { action in
            ...
            let realm = try! Realm()
            let deleteData = realm.object(ofType: LikeBenefit.self, forPrimaryKey: product.benefit_id)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "edit_benefit_likes" {
...
extension ShowLikesVC: FilterVCProtocol {
...
extension ShowLikesVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "edit_benefit_likes", sender: self)
...
extension ShowLikesVC: ShareProtocol {
    func shareWithUrl(product: SearchQueryProduct) {
        self.shareAction(benefit: product)
    }
}

extension ShowLikesVC: CustomDialogProtocl {
